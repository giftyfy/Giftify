    ...
    <>
      ...
      >
        ...
        <div className="absolute inset-0 text-white flex flex-col justify-center items-left">
          <h2 className="text-7xl font-bold mb-4" style={{marginRight:"120px"}}>Customized Gifts</h2>

          <p className="text-xl font-bold text- " style={{marginRight:"15px"}}>
            Make your gift truly one-of-a-kind with our collection of personalized gifts.
            <p>
            Whether you're seeking a gift for a special occasion or want to customize your gift</p>
            with names or personal messages, we are here to fulfill your desires.
          </p>
          </div>
          </div>
            <nav
