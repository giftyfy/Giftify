...
/>
        <div style={{ position: 'absolute', bottom: '0', left: '2', width: '100%',height:'30%', backgroundColor: 'rgb(30, 58, 138, 2)', padding: '1rem', borderRadius: '0 0 1rem 1rem', textAlign: 'center' }}>
          <p style={{ fontSize: '1.2rem', color: '#ffffff', marginBottom: '0.1rem' }}>{item.product_name}</p>
          <p style={{ fontSize: '1rem', color: '#ffffff' }}>{item.price}</p>
        </div>
      </div>
    </Link>
  </div>
