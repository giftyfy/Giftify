    ...
    <>
      ...
      >
        ...
        <div className="absolute inset-0 text-white flex flex-col justify-center items-center">
          <h2 className="text-4xl font-bold mb-4" style={{marginRight:"58%"}}> Expressive Cards for Every Occasion</h2>

          <p className="text-xl font-bold text-center " style={{marginRight:"60%"}}>
          Discover our unique collection of cards, blending elegance with emotion.   
          Perfect for birthdays, weddings, or expressing love and gratitude 
          <br/>Choose a card and send an unforgettable message straight to the heart.<br/>
         </p>
          </div>
          </div>
            <nav
